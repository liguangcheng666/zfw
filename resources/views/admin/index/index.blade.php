...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs">好客租房后台管理系统</a>
                ...
                <dd>
                    <ul>
                        @foreach($item['sub'] as $subitem)
                            <li><a data-href="{{ route($subitem['router_name']) }}" data-title="{{ $subitem['name'] }}"
